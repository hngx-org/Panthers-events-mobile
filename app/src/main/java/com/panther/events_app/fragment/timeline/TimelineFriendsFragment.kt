...
import com.panther.events_app.databinding.FragmentTimelineFriendsBinding
import com.panther.events_app.models.Items

class TimelineFriendsFragment : Fragment() {

    private var _binding : FragmentTimelineFriendsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTimelineFriendsBinding.inflate(inflater, container, false)
        return binding.root
    }
